...
class Playlist {
    ...
    reproduzir() {
        if (this.musicas.length > 0) {
            ...
            return "Reproduzindo: " + this.musicas[this.indiceAtual].titulo + ' - ' + this.musicas[this.indiceAtual].arista;
        }
        else {
...
const musica1 = new Musica("Vai namora comigi sim", "Henrique e Juliano", 300);
const musica2 = new Musica("Hoje eu quero me perder", "Lagum", 500);
const musica3 = new Musica("Meio termo", "Luan Santana", 500);
